...
parser.add_argument("--example_pattern")
...
example_pattern: Optional[str] = args.example_pattern
top: int = args.top
...
print("\n\n########################### EXAMPLES ###########################")
print("Covered {:2.2%}".format(
    covered_number_of_examples/total_number_of_examples))
...
print("Example candidates: (top " + str(max_examples) +
      " with least amount of missing sources)")
for (example_name, example_library) in remaining_examples:
    if example_pattern and not re.findall(example_pattern, example_name):
        continue
...
print("\n\n########################## LIBRARIES ###########################")
print("Covered {:2.2%} (obj only)".format(
    covered_libraries_obj/total_libraries))
