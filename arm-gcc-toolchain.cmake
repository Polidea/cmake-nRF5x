...
if (NOT DEFINED ARM_NONE_EABI_TOOLCHAIN_PATH)
    ...
    get_filename_component(ARM_NONE_EABI_TOOLCHAIN_PATH ${BINUTILS_PATH} DIRECTORY)
endif ()
...
set(TOOLCHAIN_PATH_AND_PREFIX ${ARM_NONE_EABI_TOOLCHAIN_PATH}/${TOOLCHAIN_PREFIX})
...
set(CMAKE_SYSROOT ${ARM_NONE_EABI_TOOLCHAIN_PATH})
set(CMAKE_FIND_ROOT_PATH ${ARM_NONE_EABI_TOOLCHAIN_PATH})
